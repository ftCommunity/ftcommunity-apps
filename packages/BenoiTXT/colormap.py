...
def listColorMaps():
    return ["default","rainbow","forest","planet","beach","fire","dreamy","autumn","icy","r-g-b","y-c-m","amstrad","zuse","boole","roentgen","3d glasses","soylent green","douglas adams","matrix","from hell", "night flash"]
